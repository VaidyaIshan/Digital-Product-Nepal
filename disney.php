...
<div class="header">
    ...
    <div class="container">
        <div class="image-container">
            <img src="Logos/Disney.webp" alt="Prime Video Subscription" width="800" height="600">
        </div>
        <div class="form-container">
            <h2>Order Disney Hotstar Subscription</h2>
            <form method="POST">
            <div class="form-group">
                ...
                <div class="price-display" id="priceDisplay">Rs 549</div>
