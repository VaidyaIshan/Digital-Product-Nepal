...
<div class="header">
    ...
    <div class="container">
        <div class="image-container">
            <img src="Logos/truecaller.png" alt="Prime Video Subscription" width="800" height="600">
        </div>
        <div class="form-container">
            <h2>Order TrueCaller Subscription</h2>
            <form method="POST">
            <div class="form-group">
                ...
                <div class="price-display" id="priceDisplay">Rs 299</div>
