...
<link rel="manifest" href="/src/site.webmanifest">
    ...
    <title>Netflix Subscription - Digital Product Nepal</title>
    <style>
        body {
       ...
       /* Responsive CSS */
        @media (max-width: 768px) {
            ...
            .menu-icon {
                display: block; /* Display only on smaller screens */
            }
...
<div class="header">
    ...
    <div class="container">
        <div class="image-container">
            <img src="Logos/Netflix.jpg" alt="Netflix Subscription" width="800" height="600">
        </div>
        <div class="form-container">
            <h2>Order Netflix Subscription</h2>
            <form method="POST">
                <div class="form-group">
                    ...
                    <select id="screenOption" name="screenOption" onchange="updatePrice()" class="form-inp">
                        ...
                        <option value="2">2 Screens/Devices</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <input class="form-inp" type="email" placeholder="Enter your email" name="email" required>
                ...
                <div class="price-display" id="priceDisplay">Rs 399</div>
    ...
    <script>
        ...
        function updatePrice() {
            var screenOption = document.getElementById('screenOption').value;
