...
<body>
    ...
    <div class="container">
        <div class="image-container">
            <img src="Logos/prime.png" alt="Prime Video Subscription" width="800" height="600">
        </div>
        <div class="form-container">
            <h2>Order Prime Video Subscription</h2>
            <form method="POST">
                <div class="form-group">
                    <label for="screenOption">Choose Screen/Device:</label>
                    <select id="screenOption" name="screenOption" class="form-inp">
                ...
                <div class="price-display" id="priceDisplay">Rs 150</div>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            if (durationOption === '1') {
                price = 150;
            } else if (durationOption === '3') {
                price = 400;
            } else if (durationOption === '6') {
                price = 600;
